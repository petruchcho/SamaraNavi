...
public class WMSTileSource extends OnlineTileSourceBase {
    ...
    public String wmsTileCoordinates(MapTile value) {
        ...
        //TODO Implement correct double format
        stringBuffer.append((int) Math.round(newTile.west));
        stringBuffer.append(",");
        stringBuffer.append((int) Math.round(newTile.south));
        stringBuffer.append(",");
        stringBuffer.append((int) Math.round(newTile.east));
        stringBuffer.append(",");
        stringBuffer.append((int) Math.round(newTile.north));
